[![Build Status](https://travis-ci.org/elasticfence/elasticsearch-http-user-auth.svg?branch=5.0.2)](https://travis-ci.org/elasticfence/elasticsearch-http-user-auth)
...
## Installation 
<pre>
bin/plugin install https://raw.githubusercontent.com/elasticfence/elasticsearch-http-user-auth/5.0.2/jar/elasticfence-5.0.2-SNAPSHOT.zip
</pre>

#### Build with Maven
<pre>
mvn package clean
bin/plugin install file:///path/to/repo/jar/elasticfence-5.0.2-SNAPSHOT.zip
</pre>
